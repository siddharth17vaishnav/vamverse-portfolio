    ...
    return (
        <>
            <div id="home" className=" h-[90vh] flex flex-col justify-center mx-auto items-center">
                ...
                <h3 className="mt-5 text-2xl lg:max-w-[52%] self-center md:[text-align-last:center] text-justify ">Join our hands to scale your business with the latest augment reality technologies.</h3>
            </div>
